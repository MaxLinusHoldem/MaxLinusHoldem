...
public class EvaluateTest {
	...
	public void testTestHand() {
		...
		assertEquals(4, evaluater6.testHand());
		...
		assertEquals(0, evaluater7.testHand());
		hand = evaluater7.getHand();
		assertEquals(0, hand.size());
		
		assertEquals(5, evaluater8.testHand());
		...
		assertEquals(6, evaluater9.testHand());
		...
		assertEquals(7, evaluater10.testHand());
		...
		assertEquals(8, evaluater11.testHand());
		...
		assertEquals(8, evaluater12.testHand());
